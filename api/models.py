...
class RecipeRequest(BaseModel):
    ...
    meal_type: Optional[List[str]] = Field(None, description="Meal type: breakfast, lunch, dinner, snack")
    recipe_type: Optional[List[str]] = Field(None, description="Recipe type: entree, side-dish, snack, beverage")
    cooking_method: Optional[List[str]] = Field(None, description="Cooking method: grilled, baked, one-pot, quick")
    user_preference: Optional[str] = Field(None, description="Free-text hint for what to generate (e.g. 'recipes with cauliflower')")
